...
(
    ...
    ,input  [XLEN-1:0]  lsu_in_addr_i
    ,input  [XLEN-1:0]  lsu_in_data_wr_i
    ,input           lsu_in_rd_i
    ...
    ,input  [XLEN-1:0]  lsu_out_data_rd_i
    ...
    ,output [XLEN-1:0]  fetch_out_pc_o
    ,output          fetch_in_fault_o
    ,output [XLEN-1:0]  lsu_in_data_rd_o
    ,output          lsu_in_accept_o
    ,output          lsu_in_ack_o
    ,output          lsu_in_error_o
    ,output [ 10:0]  lsu_in_resp_tag_o
    ,output [XLEN-1:0]  lsu_out_addr_o
    ,output [XLEN-1:0]  lsu_out_data_wr_o
    ,output          lsu_out_rd_o
